    ...
    >
      <div
        style={{
          ...
          width: "80px",
          zIndex: 2,
          background: "linear-gradient(to right,#08080C,transparent)",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          width: "80px",
          zIndex: 2,
          background: "linear-gradient(to left,#08080C,transparent)",
          pointerEvents: "none",
        }}
      />
      <div
        ...
        >
          <div
            style={{
              ...
              pointerEvents: "none",
              background:
                "radial-gradient(circle,rgba(99,255,180,0.07) 0%,transparent 70%)",
            }}
          />
          <div
            style={{
          ...
          <div style={S.inner}>
            ...
            >
              ...
              >
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          borderTopColor: "#63FFB4",
                          borderRightColor: "rgba(99,255,180,0.2)",
                        }}
                      />
                      <div
                        style={{
                ...
                >
                  I build scalable web applications — from pixel-perfect
                  frontends to robust backend systems. Passionate about clean
                  code, great UX, and solving real problems.
                </p>
                      ...
                      >
                        ...
                        <div style={{ padding: "20px", lineHeight: 2.1 }}>
                          <div>
                            ...
                            <span style={{ color: "#79b8ff" }}>dev</span>{" "}
                          ...
                          <div>
                            &nbsp;&nbsp;
                            <span style={{ color: "#63FFB4" }}>role</span>
                            <span style={{ color: "#e8eaf0" }}>:</span>{" "}
                            <span style={{ color: "#ffab70" }}>
                              'Full Stack Dev'
                            </span>
                          ...
                          <div>
                            &nbsp;&nbsp;
                            <span style={{ color: "#63FFB4" }}>stack</span>
                            <span style={{ color: "#e8eaf0" }}>: [</span>
                          </div>
                          <div>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <span style={{ color: "#ffab70" }}>'React'</span>
                            <span style={{ color: "#e8eaf0" }}>, </span>
                            <span style={{ color: "#ffab70" }}>'Node.js'</span>
                            <span style={{ color: "#e8eaf0" }}>,</span>
                          </div>
                          <div>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <span style={{ color: "#e8eaf0" }}>, </span>
                            <span style={{ color: "#ffab70" }}>'Express'</span>
                          </div>
                          <div>
                            &nbsp;&nbsp;
                            <span style={{ color: "#e8eaf0" }}>],</span>
                          ...
                          <div>
                            &nbsp;&nbsp;
                            <span style={{ color: "#63FFB4" }}>available</span>
                            <span style={{ color: "#e8eaf0" }}>:</span>{" "}
                            <span style={{ color: "#f97583" }}>true</span>
                            <span style={{ color: "#e8eaf0" }}>,</span>
                          </div>
                          <div>
                            &nbsp;&nbsp;
                            <span style={{ color: "#63FFB4" }}>coffee</span>
                            <span style={{ color: "#e8eaf0" }}>:</span>{" "}
                            <span style={{ color: "#ffab70" }}>
                              'always ☕'
                            </span>
                      ...
                      >
                        <div
                          style={{
                            ...
                            pointerEvents: "none",
                            background:
                              "radial-gradient(ellipse at 50% 0%,rgba(99,255,180,0.08) 0%,transparent 60%)",
                          }}
                        />
                        <div
                          style={{
                        ...
                        >
                          <div
                            ...
                            style={{
                              ...
                              border: "2px solid transparent",
                              borderTopColor: "#63FFB4",
                              borderRightColor: "rgba(99,255,180,0.25)",
                            }}
                          />
                          <div
                            style={{
              ...
              >
                ...
                <Link
                  ...
                  style={{
                    ...
                    textDecoration: "none",
                    fontFamily: "'Outfit',sans-serif",
                    borderBottom: "1px solid rgba(99,255,180,0.3)",
                    paddingBottom: "2px",
        ...
        >
          <div
            style={{
              ...
              pointerEvents: "none",
              background:
                "radial-gradient(ellipse,rgba(99,255,180,0.06) 0%,transparent 70%)",
            }}
          />
          <div
            style={{ position: "relative", ...S.inner, textAlign: "center" }}
          >
            <Reveal>
              <p
                style={{
