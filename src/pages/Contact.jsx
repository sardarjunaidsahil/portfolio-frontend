...
const CONTACT_INFO = [
    { icon: "✉", label: "Email", value: "sardarjunaidsahil@gmail.com", href: "mailto:sardarjunaidsahil@gmail.com" },
    { icon: "📞", label: "Phone / WhatsApp", value: "+92 339 3999039", href: "https://wa.me/923393999039" },
    { icon: "📍", label: "Location", value: "Lahore, Pakistan", href: null },
    { icon: "⌥", label: "GitHub", value: "github.com/sardarjunaidsahil", href: "https://github.com/sardarjunaidsahil" },
    { icon: "↗", label: "MAUVE (Live)", value: "mauve-store.vercel.app", href: "https://mauve-store.vercel.app" },
    { icon: "↗", label: "ShopingNow (Live)", value: "shopingnow56.netlify.app", href: "https://shopingnow56.netlify.app" },
];
...
export default function Contact() {
    ...
    const inputStyle = (name) => ({
        ...
        border: focused === name ? "1px solid rgba(99,255,180,0.5)" : "1px solid rgba(99,255,180,0.12)",
    ...
    const labelStyle = {
        ...
        fontSize: "0.65rem", color: "#8892a4", letterSpacing: "0.1em",
    ...
    return (
        <>
            ...
            <div style={{ background: "#08080C", minHeight: "100vh", paddingTop: "72px", overflowX: "hidden" }}>
                ...
                {/* ── Header ── */}
                <section className="contact-header-section" style={{
                    ...
                    <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 2rem", position: "relative" }}>
                        <Reveal>
                            ...
                            <h1 style={{
                                ...
                                fontSize: "clamp(1.6rem,5vw,3.8rem)", color: "#fff",
                            ...
                            <p style={{
                                color: "#8892a4", fontSize: "0.92rem", lineHeight: 1.8,
                                maxWidth: "480px", fontFamily: "'Outfit',sans-serif", margin: 0
                            }}>
                        ...
                        <Reveal delay={0.2}>
                            <div className="contact-badge" style={{
                                ...
                                marginTop: "1.2rem", padding: "10px 20px", borderRadius: "4px",
                                border: "1px solid rgba(99,255,180,0.2)", background: "rgba(99,255,180,0.05)"
                            }}>
                                <span className="contact-dot" style={{
                                    width: "8px", height: "8px", borderRadius: "50%",
                                    background: "#63FFB4", boxShadow: "0 0 8px rgba(99,255,180,0.6)"
                                }} />
                                <span style={{
                                    fontFamily: "'JetBrains Mono',monospace", fontSize: "0.65rem",
                                    color: "#63FFB4", letterSpacing: "0.08em"
                                }}>
                ...
                {/* ── Main Grid ── */}
                <section className="contact-main-section" style={{ padding: "4rem 0 6rem" }}>
                            ...
                            <div>
                                <Reveal>
                                    <h2 style={{
                                        ...
                                        fontSize: "1.1rem", color: "#fff", margin: "0 0 1.2rem 0"
                                    }}>
                                        Get in touch
                                    </h2>
                                </Reveal>

                                <div className="contact-info-gap" style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
                                        ...
                                        <Reveal key={item.label} delay={i * 0.07} direction="left">
                                            ...
                                            >
                                                <span style={{
                                                    ...
                                                    background: "rgba(99,255,180,0.07)", border: "1px solid rgba(99,255,180,0.15)",
                                                ...
                                                <div style={{ minWidth: 0 }}>
                                                    <span style={{
                                                        display: "block", fontFamily: "'JetBrains Mono',monospace",
                                                        fontSize: "0.58rem", color: "#4a5568", letterSpacing: "0.1em",
                            ...
                            <Reveal delay={0.1} direction="right">
                                <div style={{
                                    ...
                                    <div style={{
                                        ...
                                        <span style={{ marginLeft: "8px", fontFamily: "'JetBrains Mono',monospace", fontSize: "0.62rem", color: "#4a5568" }}>new_message.js</span>
                                    </div>

                                    <div style={{ padding: "2rem" }}>
                                        {sent ? (
                                            <div style={{ textAlign: "center", padding: "3rem 1rem" }}>
                                                <div className="check-pop" style={{ fontSize: "3rem", marginBottom: "1rem" }}>✓</div>
                                                <h3 style={{ fontFamily: "'Outfit',sans-serif", fontWeight: 700, fontSize: "1.3rem", color: "#63FFB4", margin: "0 0 8px 0" }}>
                                                    Message Sent!
                                                </h3>
                                                <p style={{ color: "#8892a4", fontSize: "0.88rem", fontFamily: "'Outfit',sans-serif", lineHeight: 1.7, margin: "0 0 1.5rem 0" }}>
                                                ...
                                                <button onClick={() => { setSent(false); setForm({ name: "", email: "", subject: "", message: "" }); }} style={{
                                                    ...
                                                    border: "1px solid rgba(99,255,180,0.3)", borderRadius: "2px",
                                                    cursor: "pointer", transition: "all 0.3s",
                                                }}
                                                    onMouseEnter={e => { e.target.style.background = "rgba(99,255,180,0.05)"; e.target.style.borderColor = "#63FFB4"; }}
                                                    onMouseLeave={e => { e.target.style.background = "transparent"; e.target.style.borderColor = "rgba(99,255,180,0.3)"; }}
                                                >Send Another</button>
                                            </div>
                                        ) : (
                                            <form onSubmit={handleSubmit}>
                                                <div className="name-email-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
                                                    <div>
                                                        <label style={labelStyle}>Name</label>
                                                        <input name="name" value={form.name} required placeholder="Muhammad Junaid"
                                                ...
                                                <div style={{ marginBottom: "1rem" }}>
                                                    ...
                                                    <input name="subject" value={form.subject} required placeholder="Project inquiry / Hiring / Collaboration"
                                                ...
                                                <button type="submit" disabled={sending} style={{
                                                    width: "100%", padding: "14px", fontSize: "0.9rem", fontWeight: 700,
                                                    fontFamily: "'Outfit',sans-serif",
                                                    background: sending ? "rgba(99,255,180,0.5)" : "#63FFB4",
                                                    color: "#08080C", border: "1px solid #63FFB4", borderRadius: "2px",
                                                    cursor: sending ? "wait" : "pointer",
                                                    clipPath: "polygon(12px 0%,100% 0%,calc(100% - 12px) 100%,0% 100%)",
                                                    transition: "all 0.3s",
                                                }}
                                                    onMouseEnter={e => { if (!sending) { e.target.style.background = "transparent"; e.target.style.color = "#63FFB4"; } }}
                                                    onMouseLeave={e => { if (!sending) { e.target.style.background = "#63FFB4"; e.target.style.color = "#08080C"; } }}
                                                >
                                                    {sending ? "Sending..." : "Send Message →"}
                                                </button>

                                                <p style={{ marginTop: "12px", fontFamily: "'JetBrains Mono',monospace", fontSize: "0.6rem", color: "#4a5568", textAlign: "center", letterSpacing: "0.06em" }}>
