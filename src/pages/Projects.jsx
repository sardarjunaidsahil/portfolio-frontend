...
const PROJECTS = [
  {
    ...
    short:
      "Full-stack fashion store with 315+ products, admin dashboard & complete auth system.",
  ...
  },
  {
    ...
    short:
      "Complete shopping platform with cart, checkout, secure auth & fully responsive UI.",
  ...
  },
  {
    ...
    short:
      "Full healthcare management system with doctor listings, appointment booking, OTP auth & admin dashboard.",
    desc: "Built a complete healthcare platform from scratch. Features doctor listings with specialty filtering, patient registration with OTP verification and password reset. Appointment booking with calendar scheduling and automated patient email notifications. Admin dashboard with analytics using Recharts, full CRUD for doctors, appointments and patients. Cloudinary image uploads, GSAP/Framer Motion animations, Zustand + React Query for state management.",
    tags: [
      "React.js",
      "Node.js",
      "Express.js",
    ...
    featured: true,
    highlights: [
      "Doctor listings with specialty filtering & patient OTP verification",
      "Appointment booking with calendar scheduling",
      "Automated patient email notifications via Nodemailer",
      "Admin dashboard with analytics (Recharts) & full CRUD",
      "Cloudinary image uploads & GSAP/Framer Motion animations",
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              pointerEvents: "none",
              background:
                "radial-gradient(circle,rgba(99,255,180,0.05) 0%,transparent 70%)",
            }}
          />
          ...
          >
            ...
            >
              <span
                style={{ width: "24px", height: "1px", background: "#63FFB4" }}
              />
              Portfolio
            </div>
        ...
        <div
          style={{
            ...
            borderBottom: "1px solid rgba(99,255,180,0.06)",
            padding: "1rem 0",
          }}
        >
          <div
            ...
            {FILTERS.map((f) => (
              <button
                ...
                style={{
                  ...
                  background:
                    active === f ? "rgba(99,255,180,0.1)" : "transparent",
          ...
          >
                ...
                >
                  ...
                  <div
                    style={{
                      height: "2px",
                      background:
                        "linear-gradient(to right,#63FFB4,rgba(99,255,180,0.3),transparent)",
                    }}
                  />
                  ...
                  <div style={{ padding: "2rem 2rem 1.8rem" }}>
                      ...
                      >
                        <a
                          ...
                          onMouseEnter={(e) => {
                            ...
                            e.currentTarget.style.color = "#63FFB4";
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.background = "#63FFB4";
                        ...
                        <a
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.borderColor = "#63FFB4";
                            e.currentTarget.style.background =
                              "rgba(99,255,180,0.05)";
                          }}
                          onMouseLeave={(e) => {
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontFamily: "'JetBrains Mono',monospace",
                        fontSize: "0.7rem",
                        color: "rgba(99,255,180,0.55)",
                        letterSpacing: "0.06em",
                        transition: "color 0.2s",
                      }}
                      onMouseEnter={(e) => (e.target.style.color = "#63FFB4")}
                      onMouseLeave={(e) =>
                        (e.target.style.color = "rgba(99,255,180,0.55)")
                      }
                    >
            ...
            <div
              style={{
                marginTop: "2.5rem",
                padding: "1.8rem",
                border: "1px dashed rgba(99,255,180,0.12)",
                borderRadius: "6px",
                textAlign: "center",
                background: "rgba(99,255,180,0.015)",
              }}
            >
              <span
                style={{
