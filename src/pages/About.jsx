...
const EXPERIENCE = [
  {
    ...
    period: "2023 — Present",
    points: [
      "Built three full-stack platforms independently — two e-commerce stores and a healthcare management system",
      "Handled complete project lifecycle — requirements, development, testing and deployment",
      "All applications are live with real users and continue to receive updates",
      "Work includes appointment systems, admin dashboards, email notifications and performance improvements",
    ],
  },
];
...
const STRENGTHS = [
  {
    ...
    desc: "Independently builds & deploys complete production apps — database schema to UI.",
  },
  {
    icon: "🔍",
    title: "Problem Solver",
    desc: "Strong at debugging, writing maintainable code & solving real-world problems.",
  },
  {
    icon: "🚀",
    title: "Fast Learner",
    desc: "Quickly picks up new frameworks & integrates third-party services.",
  },
  {
    icon: "🌐",
    title: "End-to-End Dev",
    desc: "Experienced across the entire stack — frontend, backend, DB & deployment.",
  },
];
  ...
  return (
    <>
      ...
      >
              ...
              <div>
                ...
                <Reveal delay={0.1}>
                  ...
                  >
                    Building the web,
                    <br />
                    <span className="about-grad-text">one commit</span>
                    <br />
                    at a time.
                  </h1>
                </Reveal>
                <Reveal delay={0.2}>
                  ...
                  >
                    I'm{" "}
                    <strong style={{ color: "#fff" }}>Muhammad Junaid</strong> —
                    a Full Stack Developer and BSc CS student based in{" "}
                    <strong style={{ color: "#fff" }}>Lahore, Pakistan</strong>.
                ...
                <Reveal delay={0.3}>
                  ...
                  >
                    Certified by{" "}
                    <strong style={{ color: "#63FFB4" }}>PNY Trainings</strong>{" "}
                    and actively freelancing since 2023 — I've shipped two live
                    e-commerce platforms that real users interact with every
                    day.
                  </p>
                </Reveal>
                <Reveal delay={0.4}>
                ...
                >
                  ...
                  <div style={{ padding: "1.5rem" }}>
                    {[
                      ...
                      >
                        <span style={{ color: "#63FFB4", minWidth: "110px" }}>
                          {key}:
                        </span>
        ...
        {/* ══ STATS ════════════════════════════════ */}
        <section
          style={{ background: "#0a0a12", padding: "3rem 0" }}
          ref={statsRef}
        >
          <div
          ...
          >
            <div
              style={{
                ...
                marginBottom: "2.5rem",
                background:
                  "linear-gradient(to right,transparent,rgba(99,255,180,0.15),transparent)",
              }}
            />
            <div
                ...
                <Reveal key={i} delay={i * 0.08}>
                  <div
                    style={{
                      ...
                      padding: "1.5rem",
                      border: ed.active
                        ? "1px solid rgba(99,255,180,0.3)"
                        : "1px solid rgba(99,255,180,0.07)",
                      position: "relative",
                      overflow: "hidden",
                    ...
                    {ed.active && (
                      <div
                        style={{
                          ...
                          height: "2px",
                          background:
                            "linear-gradient(to right,#63FFB4,rgba(99,255,180,0.3))",
                        }}
                      />
                    )}
                    <div
                    ...
                    >
                      <div
                        style={{
                          ...
                          width: `${l.pct}%`,
                          background:
                            "linear-gradient(to right,#63FFB4,rgba(99,255,180,0.6))",
                          borderRadius: "2px",
                        }}
                      />
                    </div>
